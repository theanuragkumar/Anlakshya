    ...
    <div className="singlePost">
      <MetaTags>
        ...
        <meta
          id="description"
          name="description"
          content={description.split(" ").slice(0, 40).join(" ")}
        />
        ...
        <link
          rel="canonical"
          href={`https://www.anlakshya.tech/post/${title.replace(
            /[^a-zA-Z0-9]+/gi,
            "-"
          )}-${post._id}`}
        />
        ...
        <meta
          property="og:url"
          content={`https://www.anlakshya.tech/post/${title.replace(
            /[^a-zA-Z0-9]+/gi,
            "-"
          )}-${post._id}`}
        />
        ...
        <meta
          ...
          content={post.categories + " Tech Jobs"}
        />
            ...
            linkTitle && (
              <>
                <div className="InarticleAds mb-2">
                  {window.location.href.includes("anlakshya.tech") ? (
                    <InarticleAds />
                  ) : (
                    ""
                  )}
